...
var title = document.querySelector('.chat-header > h2');
...
function next(event) {
    chatroomId = document.querySelector('#chatroom').value.trim();
...
function onConnected() {
    ...
    title.innerText = 'Chat Room ID ( ' + chatroomId + ' )'
}
...
chatroomForm.addEventListener('submit', next, true)
