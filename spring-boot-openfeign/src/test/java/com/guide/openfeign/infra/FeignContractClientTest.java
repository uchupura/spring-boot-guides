...
@SpringBootTest(
        classes = {
                FeignContractClientTest.FakeFeignConfiguration.class,
                FeignContractClientTest.FakeMessagingRestService.class
        },
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class FeignContractClientTest {

    @Autowired
    private FeignContractClient client;
    ...
    @Configuration(proxyBeanMethods = false)
    @EnableFeignClients(clients = FeignContractClient.class)
    @EnableAutoConfiguration
    @RibbonClient(
            name = "contract-client",
            configuration = FeignContractClientTest.FakeRibbonConfiguration.class)
